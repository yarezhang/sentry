...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SavedSearch.is_global'
        if is_postgres():
            db.execute("ALTER TABLE sentry_savedsearch ALTER COLUMN project_id DROP NOT NULL")
            db.execute("ALTER TABLE sentry_savedsearch ADD COLUMN is_global boolean NULL")
            # Set the default separately so that we don't apply to existing rows
            db.execute("ALTER TABLE sentry_savedsearch ALTER COLUMN is_global SET DEFAULT False;")
            db.commit_transaction()
            db.execute("CREATE INDEX CONCURRENTLY {} ON sentry_savedsearch (is_global)".format(
                db.create_index_name('sentry_savedsearch', ['is_global']),
            ))
            ...
            db.add_column(
                ...
                self.gf('django.db.models.fields.NullBooleanField')(
                    ...
                    null=True),
                keep_default=False)
            # Adding index on 'SavedSearch', fields ['is_global']
            db.create_index('sentry_savedsearch', ['is_global'])
    ...
    def backwards(self, orm):
        ...
        # rows that will violate the condition.
        db.alter_column(
            'sentry_savedsearch',
            'project_id',
            self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'ebbd7d2e9d7343c99471c51b82a3fcf4d201f0aaa7a14d22a06982d59a4f83b7'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'808e7d68c126419c8e45df821295dfc595ec2e9f67f94ff98ef6d79291265b14'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Main Bluejay'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'8b9b06bd1c85420fb8e7c0cebc7294bf'", 'max_length': '64', 'db_index': 'True'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 1, 9, 0, 0)', 'db_index': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'application': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.ApiApplication']", 'null': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 2, 8, 0, 0)', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'faad4279c5c74fecbe4bfd061a56333aa22e888124164c9b812996318a043236'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'230d1f74abaa4736a3f634d71356319a63640480fa504d81a049fdbf1e77d99b'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 1, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'17aceb9e0b1642e9bfd80b278111381c'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'data': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_scheduled': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 2, 8, 0, 0)'}),
            'guid': ('django.db.models.fields.CharField', [], {'default': "'2d5f48fc93d549da9566fe1beafd7d44'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'81325d5c-e076-4443-b024-3e6267e329f9'", 'max_length': '64'}),
        ...
        'sentry.sentryappinstallation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a2642a8f-9b8d-41fb-a6fa-f67f0618cd7d'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'8b7efeae047c4d2097a6334cc9ae4cde55eb2f5384dc4be2a356b2791a596041'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'lmaftp7ocIJy62a9rwfdiCnZwurMa73a'", 'max_length': '32'})
        },
        'sentry.userip': {
