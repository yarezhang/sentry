...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sentry_dashboard', (
        ...
        db.send_create_signal('sentry', ['Dashboard'])

        # Adding unique constraint on 'Dashboard', fields ['organization', 'title']
        db.create_unique('sentry_dashboard', ['organization_id', 'title'])

        # Adding model 'Widget'
        db.create_table('sentry_widget', (
            ('id', self.gf('sentry.db.models.fields.bounded.BoundedBigAutoField')(primary_key=True)),
            ('dashboard', self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(to=orm['sentry.Dashboard'])),
            ('dashboard_order', self.gf('sentry.db.models.fields.bounded.BoundedPositiveIntegerField')()),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('display_type', self.gf('sentry.db.models.fields.bounded.BoundedPositiveIntegerField')()),
            ('organization', self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(to=orm['sentry.Organization'])),
            ('data', self.gf('jsonfield.fields.JSONField')(default={})),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('status', self.gf('sentry.db.models.fields.bounded.BoundedPositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('sentry', ['Widget'])

        # Adding unique constraint on 'Widget', fields ['organization', 'dashboard', 'dashboard_order', 'title']
        db.create_unique('sentry_widget', ['organization_id', 'dashboard_id', 'dashboard_order', 'title'])

        # Adding model 'WidgetDataSource'
        db.create_table('sentry_widgetdatasource', (
            ('id', self.gf('sentry.db.models.fields.bounded.BoundedBigAutoField')(primary_key=True)),
            ('widget', self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(to=orm['sentry.Widget'])),
        ...
        db.send_create_signal('sentry', ['WidgetDataSource'])

        # Adding unique constraint on 'WidgetDataSource', fields ['widget', 'type', 'name']
        db.create_unique('sentry_widgetdatasource', ['widget_id', 'type', 'name'])

        # # Adding field 'SentryApp.events'
        # db.add_column('sentry_sentryapp', 'events',
        #               self.gf('sentry.db.models.fields.array.ArrayField')(of=(u'django.db.models.fields.TextField', [], {})),
        #               keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'WidgetDataSource', fields ['widget', 'type', 'name']
        db.delete_unique('sentry_widgetdatasource', ['widget_id', 'type', 'name'])

        # Removing unique constraint on 'Widget', fields ['organization', 'dashboard', 'dashboard_order', 'title']
        db.delete_unique('sentry_widget', ['organization_id', 'dashboard_id', 'dashboard_order', 'title'])

        # Removing unique constraint on 'Dashboard', fields ['organization', 'title']
        db.delete_unique('sentry_dashboard', ['organization_id', 'title'])

        # Deleting model 'Dashboard'
        db.delete_table('sentry_dashboard')

        # Deleting model 'Widget'
        db.delete_table('sentry_widget')

        # Deleting model 'WidgetDataSource'
        db.delete_table('sentry_widgetdatasource')
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'3147107aae4945a3a5551dbc8d53042c0d7df0aea0f945bdab53ab208bb841eb'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'789e06bf9d0e4a85b72c78548f3b008306326063f6ce4a479350b17181af81c1'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Genuine Sturgeon'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'2779c22df05f4ed7b196abf8d6807b84'", 'max_length': '64', 'db_index': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'6a024842a1154b749ab4af41faf732e4bd99f4d370fb4dd280b84d1bf81d76c9'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'24bdda410f464742a5e167afe1805a143757fa16f8d045b28c47fb39abc6f040'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6b0a3224ad3f416f96d3f458e9eae25f'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'d788986f920c434b8c77684b8946a325'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ae282f32-64a6-4e3a-9d44-181eadead34b'", 'max_length': '64'}),
        ...
        'sentry.sentryappinstallation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3c6d02a0-fdb8-4ada-9834-81b0b5c0dea4'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'336a690d809547b5a6f0ac0aa9ceb4b81064b1c6fe6b47baa2713db28ca43091'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'EkuXgDfBdGTsVjT9DFvZwhLcspUYTcIF'", 'max_length': '32'})
        },
        'sentry.userip': {
        ...
        'sentry.widget': {
            'Meta': {'unique_together': "(('organization', 'dashboard', 'dashboard_order', 'title'),)", 'object_name': 'Widget'},
            'dashboard': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Dashboard']"}),
            'dashboard_order': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {}),
            'data': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
        ...
        'sentry.widgetdatasource': {
            'Meta': {'unique_together': "(('widget', 'type', 'name'),)", 'object_name': 'WidgetDataSource'},
            'data': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
